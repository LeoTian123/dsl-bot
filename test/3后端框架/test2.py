...
# 配置项 —— 请修改为你的真实后端地址
# ------------------------------
BASE_URL = "http://127.0.0.1:8000"  # 请替换为你的实际后端地址，如 http://localhost:8000
...
def main():
    with concurrent.futures.ThreadPoolExecutor(max_workers=4) as executor:
        ...
        for route_name, steps in ALL_ROUTES.items():
            session_id = f"session_{uuid.uuid4().hex[:8]}"  # 随机 session，例如 session_1a2b3c4d
